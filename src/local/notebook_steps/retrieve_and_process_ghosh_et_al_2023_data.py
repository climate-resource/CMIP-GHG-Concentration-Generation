"""
Retrieve and process Ghosh et al. (2023) data notebook steps
"""
    ...
    configured_notebooks = [
        ConfiguredNotebook(
            unconfigured_notebook=uc_nbs_dict[
                Path("013y_process-ghosh-et-al-2023-data") / "0131_process-ghosh-et-al-2023-data"
            ],
            configuration=(),
...
step: UnconfiguredNotebookBasedStep[Config, ConfigBundle] = UnconfiguredNotebookBasedStep(
    step_name="retrieve_and_process_ghosh_et_al_2023_data",
    unconfigured_notebooks=[
        UnconfiguredNotebook(
            notebook_path=Path("013y_process-ghosh-et-al-2023-data") / "0131_process-ghosh-et-al-2023-data",
            raw_notebook_ext=".py",
            summary="Retrieve and process Ghosh et al. (2023) data - process",
            doc="Process Ghosh et al. (2023) data",
        ),
    ],
