...
# %% [markdown]
# # CH4 satellite diagnostics: LINEAR_SEASONAL_LAT_STD_WEIGHT_FIT
#
# Compares `ch4` pipeline diagnostics with satellite data (`LINEAR_SEASONAL_LAT_STD_WEIGHT_FIT` fit)
