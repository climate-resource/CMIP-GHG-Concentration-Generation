...
# %% [markdown]
# # CH4 satellite diagnostics: LINEAR_SEASONAL_LAT_FIT
#
# Compares `ch4` pipeline diagnostics with satellite data (`LINEAR_SEASONAL_LAT_FIT` fit)
...
# %% [raw]
# add principal component score
# also mean of the PC score
# EOF 0 is nord-sud gradient, EOF1 is less clear, it's the second order of the lat gradient. Those corrections have peaks, do they relate to what the sat correctionc could be? We can compare with the diffs of generated ghg data. Can we justify it with the literature? papers by agage team on Methane obs, or NOAA team.
#
# We could also just look at just the satellite period: generate the ghg concentrations without obs data before the satellite period.
...
# %% [raw]
# using emissions to scale PC0, PC1 is kept constant. for PC0 first there is emissions, then ice cores.
