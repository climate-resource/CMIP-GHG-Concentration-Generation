...
# %% [markdown]
# # CH4 satellite diagnostics: LINEAR_STD_WEIGHT_FIT
#
# Compares `ch4` pipeline diagnostics with satellite data (`LINEAR_STD_WEIGHT_FIT` fit)
...
gas: str = "ch4"
satellite_fit: str = "LINEAR_STD_WEIGHT_FIT"
...
#
# The bottom line: `LINEAR_STD_WEIGHT_FIT` minus the no-satellite baseline, in the actual
