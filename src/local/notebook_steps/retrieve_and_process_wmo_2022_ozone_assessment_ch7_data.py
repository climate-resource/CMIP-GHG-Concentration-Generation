"""
Retrieve and process WMO 2022 ozone assessment ch. 7 data notebook steps
"""
    ...
    configured_notebooks = [
        ConfiguredNotebook(
            unconfigured_notebook=uc_nbs_dict[
                Path("007y_process-wmo-2022-ozone-assessment-ch7-data")
                / "0071_process-wmo-2022-ozone-assessment-ch7-data"
            ],
            configuration=(config_step.raw_data,),
            dependencies=(),
...
step: UnconfiguredNotebookBasedStep[Config, ConfigBundle] = UnconfiguredNotebookBasedStep(
    step_name="retrieve_and_process_wmo_2022_ozone_assessment_ch7_data",
    unconfigured_notebooks=[
        UnconfiguredNotebook(
            notebook_path=Path("007y_process-wmo-2022-ozone-assessment-ch7-data")
            / "0071_process-wmo-2022-ozone-assessment-ch7-data",
            raw_notebook_ext=".py",
            summary="process WMO 2022 ozone assessment data - process",
            doc="Process WMO 2022 ozone assessment data",
        ),
    ],
