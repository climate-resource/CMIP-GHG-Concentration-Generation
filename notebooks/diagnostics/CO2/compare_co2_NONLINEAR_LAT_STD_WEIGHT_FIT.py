...
# %% [markdown]
# # CO2 satellite diagnostics: NONLINEAR_LAT_STD_WEIGHT_FIT
#
# Compares `co2` pipeline diagnostics with satellite data (`NONLINEAR_LAT_STD_WEIGHT_FIT` fit)
...
#
# The bottom line: `NONLINEAR_LAT_STD_WEIGHT_FIT` minus the no-satellite baseline, in the actual
