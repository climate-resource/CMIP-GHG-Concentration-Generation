...
# %% [markdown]
# # CO2 satellite diagnostics: LINEAR_SEASONAL_LAT_STD_WEIGHT_FIT
#
# Compares `co2` pipeline diagnostics with satellite data (`LINEAR_SEASONAL_LAT_STD_WEIGHT_FIT` fit)
