...
def configure_notebooks(
    ...
    configured_notebooks = [
        ConfiguredNotebook(
            unconfigured_notebook=uc_nbs_dict[Path("006y_process-neem-data") / "0060_download-neem"],
        ...
        ConfiguredNotebook(
            unconfigured_notebook=uc_nbs_dict[Path("006y_process-neem-data") / "0061_process-neem"],
            configuration=(),
