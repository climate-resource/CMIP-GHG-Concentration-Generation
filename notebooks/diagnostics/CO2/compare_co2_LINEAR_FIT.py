...
# %% [markdown]
# # CO2 satellite diagnostics: LINEAR_FIT
#
# Compares `co2` pipeline diagnostics with satellite data (`LINEAR_FIT` fit)
...
#
# The bottom line: `LINEAR_FIT` minus the no-satellite baseline, in the actual
