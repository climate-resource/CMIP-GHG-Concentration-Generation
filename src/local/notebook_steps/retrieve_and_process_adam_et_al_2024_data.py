"""
Retrieve and process Adam et al. (2024) data notebook steps
"""
    ...
    configured_notebooks = [
        ConfiguredNotebook(
            unconfigured_notebook=uc_nbs_dict[
                Path("012y_process-adam-et-al-2024-data") / "0121_process-adam-et-al-2024-data"
            ],
            configuration=(),
...
step: UnconfiguredNotebookBasedStep[Config, ConfigBundle] = UnconfiguredNotebookBasedStep(
    step_name="retrieve_and_process_adam_et_al_2024_data",
    unconfigured_notebooks=[
        UnconfiguredNotebook(
            notebook_path=Path("012y_process-adam-et-al-2024-data") / "0121_process-adam-et-al-2024-data",
            raw_notebook_ext=".py",
            summary="Retrieve and process Adam et al. (2024) data - process",
            doc="Process Adam et al. (2024) data",
        ),
    ],
