"""
Calculate N2O monthly 15 degree pieces notebook steps
"""
    ...
    configured_notebooks = [
        ...
        ConfiguredNotebook(
            ...
            targets=(
                ...
                config_step.latitudinal_gradient_pc0_n2o_emissions_regression_file,
            ),
            config_file=config_bundle.config_hydrated_path,
            step_config_id=step_config_id,
        ),
...
step: UnconfiguredNotebookBasedStep[Config, ConfigBundle] = UnconfiguredNotebookBasedStep(
    ...
    unconfigured_notebooks=[
        ...
        UnconfiguredNotebook(
            ...
            raw_notebook_ext=".py",
            summary="N2O pieces - Observational network pieces",
            doc="Calculate latitudinal gradient, seasonality and global-mean from the observational network",
        ),
        UnconfiguredNotebook(
            notebook_path=Path("10yy_n2o-monthly-15-degree") / "1003_n2o_extend-pcs",
            raw_notebook_ext=".py",
            summary="N2O pieces - Extend PCs over the entire time period",
