...
# %% [markdown]
# # CO2 satellite diagnostics: LINEAR_LAT_STD_WEIGHT_FIT
#
# Compares `co2` pipeline diagnostics with satellite data (`LINEAR_LAT_STD_WEIGHT_FIT` fit)
...
gas: str = "co2"
satellite_fit: str = "LINEAR_LAT_STD_WEIGHT_FIT"
...
#
# The bottom line: `LINEAR_LAT_STD_WEIGHT_FIT` minus the no-satellite baseline, in the actual
