...
# LINEAR_SEASONAL_LAT_UNC_WEIGHT_FIT
...
date_path = "v20260730/"
output_path = f"{code_path}{code_data_path}/atmos/mon/ch4/gnz/{date_path}"
file = "ch4_input4MIPs_GHGConcentrations_CMIP_CR-CMIP-testing_gnz_175001-202212"
output_path

# %%
file_list = glob(output_path + "ch4_input4MIPs_GHGConcentrations_CMIP_CR-CMIP-testing_gnz_175001-20221*.nc")

prefix = "ch4_input4MIPs_GHGConcentrations_CMIP_CR-CMIP-testing_gnz_175001-20221"
...
# %%
date_path_original = "v20260731/"

output_path_original = f"{code_path}{code_data_path}/atmos/mon/ch4/gnz/{date_path_original}"

original_conc = xr.open_dataset(
    output_path_original + "ch4_input4MIPs_GHGConcentrations_CMIP_CR-CMIP-testing_gnz_175001-202212.nc"
)
original_conc

# %%
linear_fit_conc = xr.open_dataset(
    output_path + "ch4_input4MIPs_GHGConcentrations_CMIP_CR-CMIP-testing_gnz_175001-202212_SAT_LINEAR_FIT.nc"
)

# %%
linear_fit_conc.ch4.plot()
...
def plot_comp_with_original(fit_name):
    fit_conc = xr.open_dataset(
        output_path
        + "ch4_input4MIPs_GHGConcentrations_CMIP_CR-CMIP-testing_gnz_175001-202212_SAT_"
        + fit_name
        + ".nc"
    )
    (fit_conc.ch4 - original_conc.ch4).plot()
...
def plot_comp_with_original(list_of_fits):
    fig, axes = plt.subplots(1, len(list_of_fits), figsize=(18, 5), sharey=True, sharex=True)
    ...
    for fit_name in list_of_fits:
        ...
        diffs.append(fit_conc.ch4 - original_conc.ch4)
    ...
    fig.colorbar(im, cax=cbar_ax, orientation="horizontal", label="CH4 difference")
...
plot_comp_with_original(
    ["LINEAR_SEASONAL_LAT_FIT", "LINEAR_SEASONAL_LAT_STD_WEIGHT_FIT", "LINEAR_SEASONAL_LAT_STD_WEIGHT_FIT"]
)
