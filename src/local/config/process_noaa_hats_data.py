"""
Config for processing NOAA Halocarbons & other Atmospheric Trace Species (HATS) data
"""
...
@frozen
class ProcessNOAAHATSDataConfig:
    """
    Configuration class for processing NOAA HATS data
    """
