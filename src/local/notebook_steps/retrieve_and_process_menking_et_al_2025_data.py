"""
Retrieve and process Menking et al. (2025) data notebook steps
"""
    ...
    configured_notebooks = [
        ConfiguredNotebook(
            unconfigured_notebook=uc_nbs_dict[
                Path("014y_process-menking-et-al-2025-data") / "0141_process-menking-et-al-2025-data"
            ],
            configuration=(),
            dependencies=(config_step.raw_data_file,),
...
step: UnconfiguredNotebookBasedStep[Config, ConfigBundle] = UnconfiguredNotebookBasedStep(
    step_name="retrieve_and_process_menking_et_al_2025_data",
    unconfigured_notebooks=[
        UnconfiguredNotebook(
            notebook_path=Path("014y_process-menking-et-al-2025-data")
            / "0141_process-menking-et-al-2025-data",
            raw_notebook_ext=".py",
            summary="Retrieve and process Menking et al. (2025) data - process",
            doc="Process Menking et al. (2025) data",
        ),
    ],
