...
# %% [markdown]
# # CH4 - check gridded output across all satellite fits
#
# Cleaned-up successor to `check_CH4_output_sat.py`: instead of a hardcoded,
...
# downstream of everything the `compare_ch4_<FIT>.py` notebooks in this
...
# "Final gridded output diff" section of the `compare_ch4_<FIT>.py`
...
# output step, downstream of everything the `compare_ch4_<FIT>.py` notebooks
